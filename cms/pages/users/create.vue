          ...
          <ScCard>
            <ScCardHeader separator>
              <div class="uk-flex uk-flex-middle">
                ...
                <ScCardTitle> Create User </ScCardTitle>
              </div>
            </ScCardHeader>
            <ScCardBody>
              <form class="uk-form-stacked">
                ...
                <div class="uk-margin">
                  <ScInput
                    ...
                    :error-state="$v.model.password.$error"
                    :validator="$v.model.password"
                  >
                    <label class="required">Password</label>
                  </ScInput>
                  <ul class="sc-vue-errors">
                    <li v-if="!$v.model.password.required">
                      Field is required
                    </li>
                  </ul>
                </div>
                    ...
                    <li v-if="!$v.model.password_confirmation.sameAs">
                      Passwords must match.
								...
								<div class="uk-margin-medium-top">
									<button class="sc-button sc-button-primary" :class="{'sc-button-progress-overlay': loading}" :disabled="loading" @click.prevent="handleSubmit">
										<span>Create</span>
